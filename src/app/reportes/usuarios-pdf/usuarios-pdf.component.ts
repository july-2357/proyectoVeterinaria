...
@Component({
  selector: 'app-usuarios-pdf',
  templateUrl: './usuarios-pdf.component.html',
  styleUrls: ['./usuarios-pdf.component.css']
})
export class UsuariosPdfComponent implements OnInit {
  listaUsuarios: any = []; //   Variable global para guardar la inf
